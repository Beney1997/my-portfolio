...
const AboutPage = () => {
  ...
  <Link
    href="/"
    className="text-red-500 mt-2 inline-block text-sm sm:text-base md:text-lg"
  >
    Home / About Me
  </Link>
</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mx-auto max-w-5xl px-4 md:px-0 mb-20">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-800 text-sm sm:text-base mt-4">
            Hello! I am Egharevba Gift, a dedicated web developer with a strong
            passion for programming. I specialize in creating intuitive,
            user-centric applications designed to solve practical challenges. I
            believe that programming thrives on a combination of passion and
            commitment; when you invest both, the results speak for themselves.
          </p>

          <div className="flex flex-row mt-8">
            <div
              className={`cursor-pointer text-red-500 border-b-2 ${
                activeSection === "skills"
                  ? "border-purple-800"
                  : "border-transparent"
              } mr-5`}
              onClick={() =>
                handleClick(activeSection === "skills" ? "" : "skills")
              }
            >
              Skills
            </div>
            <div
              ...
              onClick={() =>
                handleClick(activeSection === "education" ? "" : "education")
              }
            >
              Education
            </div>
            <div
              ...
              onClick={() =>
                handleClick(activeSection === "experience" ? "" : "experience")
              }
            >
              Experience
            </div>
            ...
            {activeSection === "skills" && (
              <div className="text-gray-800">
                ...
                <li>
                  ...
                  Principles, Cross-Browser Compatibility
                </li>
                <li>Tools: Git/GitHub, API Integration</li>
                <li>
                  Soft Skills: Problem Solving, Debugging, Strong Communication
                  and Collaboration Skills, Customer Service, Digital Marketing,
                  etc.
                </li>
              </div>
            )}
            ...
            {activeSection === "experience" && (
              <div className="text-gray-800">
                <li>
                  ...
                  <br />
                  Reinvent Security, September 2024-present
                </li>
                <li className="mt-4">
                  <strong>Front-End Developer Intern</strong>
                  <br />
                  ACE EMDED NIG LTD, July 2024-present
                  <ul className="list-disc list-inside ml-5 mt-1">
                    <li>
                      Worked on developing user interfaces for web applications.
                    </li>
                    <li>
                    ...
                    <li>
                      Contributed to website performance optimization and
                      responsiveness.
                    </li>
                  </ul>
                </li>
                <li className="mt-4">
                  ...
                  <ul className="list-disc list-inside ml-5 mt-1">
                    <li>
                      Developed responsive web applications in collaboration
                      with cross-functional teams.
                    </li>
                    <li>
                      Implemented pixel-perfect UI/UX designs using HTML5, CSS3,
                      and JavaScript.
                    </li>
                    <li>
                      Enhanced website performance through code optimization and
                    ...
                    <li>
                      Integrated third-party APIs to extend website
                      functionality.
                    </li>
                    <li>Managed version control using Git/GitHub.</li>
                    <li>
                      Worked closely with designers and back-end developers for
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 mx-auto px-4">
            <div className="about-caption mb-50 p-6 text-[1rem] font-normal leading-[1.5] text-[#212529] text-left bg-white">
              ...
              <p className="text-[#10285d] mb-8">
                As a designer, I believe that creativity knows no boundaries. My
                journey is fueled by a deep passion for creating meaningful,
                impactful designs that resonate with people from all walks of
                life. Each project is an opportunity to blend innovation with
                inspiration drawn from the diverse cultures and experiences I
                have encountered while exploring the world. With every design, I
                strive to tell a story&mdash;one that not only captivates but
            ...
            <div className="about-caption2 w-full p-6 ml-10">
              ...
              <p className="mb-4 text-[#6c757d]">
                Late talk&apos;s with me? That is alright.
              </p>
              ...
              <div key={index} className="flex flex-col h-full">
                <div className="relative bg-white border border-gray-200 rounded shadow h-full p-4 flex">
                  ...
                  <div className="flex flex-col justify-center h-full">
                    <h2 className="text-red-500 text-lg font-medium mb-1">
                      {feedback.name}
                    </h2>
                    <h5 className="text-[#000a2d] text-lg mb-2">
                      {feedback.title}
                    </h5>
                    <p className="text-[#6c757d] mt-2">{feedback.feedback}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full h-full py-20">
          <div className="w-full md:w-1/2 mb-12 md:mb-0 ml-5 md:ml-10">
            ...
            <p className="text-[#000a2d] mb-6">
              My name is Gift, and I am excited about the possibility of working
              together to bring your ideas to life. With a passion for creating
              innovative and impactful solutions, I believe that every great
              partnership starts with the right timing and that time is now.
            </p>
            <p className="text-[#000a2d] mb-6">
              Are you looking to build a user-friendly website, improve your
              digital presence, a beautiful customer service experience or craft
              seamless experiences, I am here to help you achieve your goals.
              Let us work together to create something truly remarkable.
            </p>
          </div>
