...
const HeroSection = () => {
  return (
    <section>
      {/* Main content area with text centered */}
      <div className="flex justify-center items-center min-h-screen bg-gray-200">
        <div className="flex flex-col justify-center items-center text-center p-10 w-full mx-0">
          <p className="text-red-400 text-base md:text-lg mt-10 mb-10">
          ...
          <div className="mt-10 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-5 mb-20">
            ...
            <Link
              target="_blank"
              href="https://drive.google.com/file/d/1GE3mnd7UabfLds415rlQVSrB0GpGDmqb/view?usp=sharing"
            >
              <button className="bg-red-400 text-white px-6 py-3 rounded hover:bg-red-500 transition duration-200">
                Download CV
              </button>
        ...
        <div className="grid grid-cols-1 gap-5 mx-auto mb-10 md:grid-cols-3 lg:grid-cols-3 max-w-screen-xl px-3 ml-20 mr-20">
          <div className="relative bg-white border border-gray-200 rounded shadow h-full overflow-hidden transition-all duration-300 hover:shadow-lg group flex flex-col">
            ...
            <div className="relative z-10 p-4 flex flex-col flex-grow justify-center items-center">
              ...
              <p className="text-[#6c757d] group-hover:text-white text-center">
                A comprehensive resource designed to guide you through the web
                design process, helping you craft engaging and effective user
                experiences.
              </p>
            </div>
          </div>
          <div className="relative bg-white border border-gray-200 rounded shadow h-full overflow-hidden transition-all duration-300 hover:shadow-lg group flex flex-col">
            ...
            <div className="relative z-10 p-4 flex flex-col flex-grow justify-center items-center">
              ...
              <p className="text-[#6c757d] group-hover:text-white text-center">
                A valuable resource designed to help you master digital
                marketing strategies and elevate your online presence.
              </p>
            </div>
          </div>
          <div className="relative bg-white border border-gray-200 rounded shadow h-full overflow-hidden transition-all duration-300 hover:shadow-lg group flex flex-col">
            ...
            <div className="relative z-10 p-4 flex flex-col flex-grow justify-center items-center">
              ...
              <p className="text-[#6c757d] group-hover:text-white text-center">
                A valuable resource crafted to help you master the design
                process and enhance the quality of your work, ensuring
